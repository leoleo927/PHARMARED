...
<body>
	<div id="contenedor">
		<header>
			...
			<tools:cabecera tituloPagina="Catálogo de Productos" />
		</header>
					...
					<div class="col-3">
						<div class="form-floating">
							<select class="form-control" id="cboCategoria"
								name="cboCategoria" aria-label="Categoria">
								<%-- usamos custom tag para las opciones --%>
								<tools:comboProdCat idCategoria="1" />
							</select> <label for="cboCategoria">Categoria</label>
						</div>
					</div>
				</div>
				<div class="table-responsive">
					<table class="table">
						<tools:productoCatalogo idCategoria="1" />
					</table>
				</div>
